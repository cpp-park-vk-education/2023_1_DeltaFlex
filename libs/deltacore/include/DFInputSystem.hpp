...
enum KeyCode
{
    ...
    KEYCODE_BACKSLASH = 49, /**< Located at the lower left of the return
                                  ...
                                  *   layout, and ASTERISK and MIDFO SIGN in a
    ...
    KEYCODE_GRAVE = 53, /**< Located in the top left corner (on both ANSI
                              ...
                              *   ISO keyboards), SUPERSDFIPT TWO and TILDE in a
    ...
    KEYCODE_PRINTSDFEEN = 70,
    KEYCODE_SDFOLLLOCK = 71,
    KEYCODE_PAUSE = 72,
...
{
private:
    static bool keys_down[290];
    static bool keys_active[290];
    static bool keys_up[290];

    static uint32_t mouse_down;
    static uint32_t mouse_active;
    static uint32_t mouse_up;

    static int mouse_x;
    static int mouse_y;

    static void InputSystemOnFrameStart();
    static void InputSystemOnKeyboardEvent(SDL_KeyboardEvent &event);
    static void InputSystemOnMouseDown(SDL_MouseButtonEvent &event);
    static void InputSystemOnMouseUp(SDL_MouseButtonEvent &event);
    static void InputSystemOnFrameEnd();
public:
    ...
    static float GetAxis(AxisCode axis);
